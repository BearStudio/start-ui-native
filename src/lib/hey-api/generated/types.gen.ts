...
export type ClientOptions = {
    baseUrl: 'https://demo.start-ui.com/api/rest' | (string & {});
};
...
export type ConfigEnvResponses = {
    /**
     * OK
     */
    200: {
...
export type ConfigEnvResponse = ConfigEnvResponses[keyof ConfigEnvResponses];

export type ConfigDevtoolsData = {
    body?: never;
    path?: never;
    query?: never;
    url: '/config/devtools';
...
export type ConfigDevtoolsResponses = {
    /**
     * OK
     */
    200: {
        maildevIframeSrc?: string | null;
    };
};

export type ConfigDevtoolsResponse = ConfigDevtoolsResponses[keyof ConfigDevtoolsResponses];
