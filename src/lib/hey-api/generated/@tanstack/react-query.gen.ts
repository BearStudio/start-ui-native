...
import { accountSubmitOnboarding, accountUpdateInfo, bookCreate, bookDeleteById, bookGetAll, bookGetById, bookUpdateById, configDevtools, configEnv, genreGetAll, type Options, userCreate, userDeleteById, userGetAll, userGetById, userGetUserSessions, userRevokeUserSession, userRevokeUserSessions, userUpdateById } from '../sdk.gen';
import type { AccountSubmitOnboardingData, AccountUpdateInfoData, BookCreateData, BookCreateResponse, BookDeleteByIdData, BookGetAllData, BookGetAllResponse, BookGetByIdData, BookGetByIdResponse, BookUpdateByIdData, BookUpdateByIdResponse, ConfigDevtoolsData, ConfigDevtoolsResponse, ConfigEnvData, ConfigEnvResponse, GenreGetAllData, GenreGetAllResponse, UserCreateData, UserCreateResponse, UserDeleteByIdData, UserGetAllData, UserGetAllResponse, UserGetByIdData, UserGetByIdResponse, UserGetUserSessionsData, UserGetUserSessionsResponse, UserRevokeUserSessionData, UserRevokeUserSessionsData, UserUpdateByIdData, UserUpdateByIdResponse } from '../types.gen';
...
export const bookGetAllOptions = (options?: Options<BookGetAllData>) => queryOptions<BookGetAllResponse, DefaultError, BookGetAllResponse, ReturnType<typeof bookGetAllQueryKey>>({
...
export const bookGetAllInfiniteOptions = (options?: Options<BookGetAllData>) => infiniteQueryOptions<BookGetAllResponse, DefaultError, InfiniteData<BookGetAllResponse>, QueryKey<Options<BookGetAllData>>, string | Pick<QueryKey<Options<BookGetAllData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
// @ts-ignore
{
...
export const bookGetByIdOptions = (options: Options<BookGetByIdData>) => queryOptions<BookGetByIdResponse, DefaultError, BookGetByIdResponse, ReturnType<typeof bookGetByIdQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
...
export const genreGetAllOptions = (options?: Options<GenreGetAllData>) => queryOptions<GenreGetAllResponse, DefaultError, GenreGetAllResponse, ReturnType<typeof genreGetAllQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
...
export const genreGetAllInfiniteOptions = (options?: Options<GenreGetAllData>) => infiniteQueryOptions<GenreGetAllResponse, DefaultError, InfiniteData<GenreGetAllResponse>, QueryKey<Options<GenreGetAllData>>, string | Pick<QueryKey<Options<GenreGetAllData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
// @ts-ignore
{
    queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
...
export const userGetAllOptions = (options?: Options<UserGetAllData>) => queryOptions<UserGetAllResponse, DefaultError, UserGetAllResponse, ReturnType<typeof userGetAllQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
...
export const userGetAllInfiniteOptions = (options?: Options<UserGetAllData>) => infiniteQueryOptions<UserGetAllResponse, DefaultError, InfiniteData<UserGetAllResponse>, QueryKey<Options<UserGetAllData>>, string | Pick<QueryKey<Options<UserGetAllData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
// @ts-ignore
{
    queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
...
export const userGetByIdOptions = (options: Options<UserGetByIdData>) => queryOptions<UserGetByIdResponse, DefaultError, UserGetByIdResponse, ReturnType<typeof userGetByIdQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
...
export const userGetUserSessionsOptions = (options: Options<UserGetUserSessionsData>) => queryOptions<UserGetUserSessionsResponse, DefaultError, UserGetUserSessionsResponse, ReturnType<typeof userGetUserSessionsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
...
export const userGetUserSessionsInfiniteOptions = (options: Options<UserGetUserSessionsData>) => infiniteQueryOptions<UserGetUserSessionsResponse, DefaultError, InfiniteData<UserGetUserSessionsResponse>, QueryKey<Options<UserGetUserSessionsData>>, string | Pick<QueryKey<Options<UserGetUserSessionsData>>[0], 'body' | 'headers' | 'path' | 'query'>>(
// @ts-ignore
{
    queryFn: async ({ pageParam, queryKey, signal }) => {
        // @ts-ignore
...
export const configEnvQueryKey = (options?: Options<ConfigEnvData>) => createQueryKey('configEnv', options);

export const configEnvOptions = (options?: Options<ConfigEnvData>) => queryOptions<ConfigEnvResponse, DefaultError, ConfigEnvResponse, ReturnType<typeof configEnvQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await configEnv({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: configEnvQueryKey(options)
});

export const configDevtoolsQueryKey = (options?: Options<ConfigDevtoolsData>) => createQueryKey('configDevtools', options);

export const configDevtoolsOptions = (options?: Options<ConfigDevtoolsData>) => queryOptions<ConfigDevtoolsResponse, DefaultError, ConfigDevtoolsResponse, ReturnType<typeof configDevtoolsQueryKey>>({
    queryFn: async ({ queryKey, signal }) => {
        const { data } = await configDevtools({
            ...options,
            ...queryKey[0],
            signal,
            throwOnError: true
    ...
    queryKey: configDevtoolsQueryKey(options)
});
